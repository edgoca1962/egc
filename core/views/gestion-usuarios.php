                        ...
                        <?php if ($state['can_manage_status']) : ?>
                            ...
                            <td>
                                <form method="post" action="<?php echo esc_url($state['admin_general_form_action']); ?>">
                                    ...
                                    <input type="hidden" name="user_id" value="<?php echo esc_attr($user['id']); ?>">
                                    <input type="hidden" name="is_admin_general" value="<?php echo $user['is_admin_general'] ? '0' : '1'; ?>">
                                    <?php
                                    ...
                                    >
                                        <i class="bi <?php echo $user['is_admin_general'] ? 'bi-person-check-fill' : 'bi-person-fill'; ?>" aria-hidden="true"></i>
                                    </button>
                                </form>
                            </td>
                        <?php endif; ?>
