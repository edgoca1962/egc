...
$style     = $atributos['image']
    ? 'background-image:url(' . esc_url($atributos['image']) . ');background-size:cover;background-position:center;'
    : '';
?>
<div class="egc-banner text-white text-center py-5<?php echo $atributos['image'] ? '' : ' bg-dark'; ?>"
