...
<div class="container py-5" style="max-width: 480px;">
    ...
    <div class="text-center mb-4">
        <img src="<?php echo esc_url($state['avatar_url']); ?>" alt="" id="avatar-preview" class="rounded-circle"
    ...
    <form method="post" action="<?php echo esc_url($state['form_action']); ?>" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" type="email" id="email" value="<?php echo esc_attr($state['email']); ?>"
                disabled>
        </div>
