...
<div class="container py-5">
    <h1 class="h3 mb-4"><?php esc_html_e('Mis publicaciones', 'egc'); ?></h1>
    ...
    <div class="card mb-5">
        <div class="card-body">
            <h2 class="h5 mb-3"><?php esc_html_e('Nueva publicación', 'egc'); ?></h2>
            ...
            <form method="post" action="<?php echo esc_url($state['form_action']); ?>">
                ...
                <div class="mb-3">
                    ...
                    <?php wp_editor('', 'post_content', ['textarea_name' => 'post_content']); ?>
                </div>
            ...
            <table class="table align-middle">
                ...
                <?php foreach ($state['posts'] as $post) : ?>
                    <tr>
                        ...
                        <td class="text-end">
                            <?php $actions = $post; include EGC_DIR . '/modules/blog/views/partials/post-actions.php'; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
